...
because they have been _archived_[^1] on, or _removed_[^2] from, CRAN
during the last `{r} max_days` days. The table shows date when a
...
Packages that are not unarchived on CRAN within `{r} max_days` days,
are removed also from CRANhaven[^4].
