...
production and do _not_ add CRANhaven to `Additional_repositories` of
your package.
...
hosts packages that were recently archived on CRAN[^1]. Those packages
...
[^1]: The "Commit" datestamps seen on [R-universe] show the dates (±1
day) when the packages were archived on CRAN.
...
"unarchived" again at some point in the future. [Our results] show that the
median time for an archived package to reappear on CRAN is ~30 days.
...
[Our results]: cran-archiving-stats.html
