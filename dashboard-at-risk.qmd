...
atrisk$Links <- sprintf('<a href="https://cran.r-project.org/web/checks/check_results_%s.html"><img src="https://badges.cranchecks.info/worst/%s.svg" alt="CRAN check worst result for package %s"></a>', atrisk$Package, atrisk$Package, atrisk$Package)
...
revdeps <- strsplit(revdeps, split = ",", fixed = TRUE)
nrevdeps <- lengths(revdeps)
atrisk[["Reverse Packages (n)"]] <- nrevdeps
revdeps <- vapply(revdeps, FUN = function(pkgs) {
  paste(pkgs, collapse = ", ")
}, FUN.VALUE = "")
atrisk[["Reverse Packages"]] <- revdeps
atrisk$Package <- sprintf('<a href="https://cran.r-project.org/package=%s">%s</a><br><img src="https://cranlogs.r-pkg.org/badges/last-month/%s" alt="Number of downloads during the last month for package %s">', atrisk$Package, atrisk$Package, atrisk$Package, atrisk$Package)
