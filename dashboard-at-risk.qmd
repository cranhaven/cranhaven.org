...
atrisk <- merge(atrisk, incoming, 
                by.x = "Package", by.y = "package", 
                all.x = TRUE)
idxs <- which(!is.na(atrisk$cran_incoming))
atrisk$event <- NA
atrisk$event[idxs] <- sprintf('<small><a href="https://nx10.github.io/cransubs/pkg#%s">resubmitted/%s</a></small>', atrisk$Package[idxs], atrisk$cran_incoming[idxs])
